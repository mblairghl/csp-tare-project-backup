...
const Step5 = () => {
  ...
  const howThisWorksContent = {
    description: "Step 5 detailed description of how this works.",
    steps: [{'title': 'Sub Step 1', 'description': 'Description for sub step 1 of step 5.', 'color': 'bg-green-600', 'textColor': '#16a34a'}, {'title': 'Sub Step 2', 'description': 'Description for sub step 2 of step 5.', 'color': 'bg-blue-600', 'textColor': '#2563eb'}, {'title': 'Sub Step 3', 'description': 'Description for sub step 3 of step 5.', 'color': 'bg-yellow-600', 'textColor': '#ca8a04'}]
  };
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto p-6">
        ...
        <p className="text-lg text-gray-600 mb-6">
          Step 5 objective description goes here.
        </p>
        ...
        <div className="bg-white rounded-lg border shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 mb-8">
          ...
          <div className="p-6">
            {activeTab === 'tab-1' && (
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-4">AI Sales Pipeline Automation</h3>
                <p className="text-gray-600 mb-6">
                  Use AI to create an automated sales process that qualifies prospects and converts them efficiently while protecting your time.
                </p>
                
                <div className="space-y-4">
                  <button 
                    onClick={() => {
                      const aiPrompt = `I'm working on Step 5 of my Authority Revenue Toolkit - Sales Pipeline Automation. I need help creating an automated sales process that qualifies prospects and converts them efficiently.

Based on my business details, please help me create a sales pipeline automation system:

My Business: [DESCRIBE YOUR BUSINESS HERE]
My Sales Process: [DESCRIBE CURRENT PROCESS HERE]
My Ideal Clients: [PASTE YOUR PERSONAS FROM STEP 1 HERE]

Please provide:
1. Lead qualification automation criteria
2. Automated email sequences for different prospect types
3. Discovery call framework and questions
4. Proposal templates and automation triggers
5. Follow-up sequences for different scenarios (interested, not ready, objections)
6. CRM workflow recommendations
7. Sales metrics to track and optimize

Make this system protect my time while maximizing conversion rates.`;
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                    ...
                    <ol className="text-blue-700 text-sm space-y-1">
                      <li>1. Click "Generate AI Sales Automation" to open ChatGPT</li>
                      <li>2. Fill in your current sales process and business details</li>
                      <li>3. Copy the AI-generated automation system</li>
                      <li>4. Use "Manual Pipeline Setup" to implement and configure your CRM</li>
                    </ol>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="bg-green-50 p-6 rounded-lg border border-green-200">
                  ...
                  <p className="text-green-700">
                    You've successfully completed Step 5. Great work on your progress!
                  </p>
                </div>
              </div>
            )}
        ...
        <AIModal
          ...
          title="AI-Generated Step 5 Strategy"
          loading={aiLoading}
        >
          {aiResult && (
            <div>
              <p className="text-gray-600 mb-6">
                Here's your AI-generated strategy for Step 5:
              </p>
