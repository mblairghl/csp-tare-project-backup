...
const Step2 = () => {
  ...
  // Sub-steps configuration with NUMBERS
  const subSteps = [
...
*This copy is generated based on your current content audit and can be customized for specific campaigns, landing pages, or sales conversations.*`;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* ORIGINAL DESIGN: Full width container */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          {/* ORIGINAL DESIGN: Action Steps Navigation with NUMBERS */}
        ...
        <div className="space-y-8">
          {/* Sub-step 1: Content Library - ORIGINAL TWO COLUMN LAYOUT */}
          {activeSubStep === 0 && (
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                {/* ORIGINAL DESIGN: LARGER Content Library Display */}
                {contentLibrary.length > 0 && (
                  <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-6">
                        ...
                        <div key={content.id} className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                          <div className="flex justify-between items-start">
                            <div className="flex-1">
                              <h5 className="font-semibold text-gray-900 text-lg">{content.name}</h5>
                              <p className="text-sm text-gray-600 font-medium">{content.type}</p>
                              {content.description && (
                                <p className="text-sm text-gray-700 mt-2 leading-relaxed">{content.description}</p>
                              )}
                              {content.notes && (
                                <p className="text-xs text-gray-500 mt-1 italic">{content.notes}</p>
                              )}
                              {content.isAiSuggestion && (
                                <span className="inline-block mt-2 px-3 py-1 bg-[#d7df21] text-xs rounded-full font-medium">
                                  AI Suggestion
                                </span>
                              )}
                            </div>
        ...
        {/* All Modals - Same as before but keeping them for functionality */}
        {/* Add Content Modal */}
        {addContentModalOpen && (
