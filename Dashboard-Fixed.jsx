...
const Dashboard = () => {
  ...
  const steps = [
    { id: 1, title: 'Ideal Client Refinement', color: 'bg-purple-500', completed: stepProgress.step1 },
    { id: 2, title: 'Marketing Funnel Mapping', color: 'bg-orange-500', completed: stepProgress.step2 },
    { id: 3, title: 'Lead Intelligence', color: 'bg-pink-500', completed: stepProgress.step3 },
    { id: 4, title: 'Signature Funnel Build', color: 'bg-teal-500', completed: stepProgress.step4 },
    { id: 5, title: 'Sales Pipeline Automation', color: 'bg-pink-500', completed: stepProgress.step5 },
    { id: 6, title: 'Build Your Delivery System', color: 'bg-purple-500', completed: stepProgress.step6 },
    { id: 7, title: 'Metrics & Monitoring', color: 'bg-red-500', completed: stepProgress.step7 },
    { id: 8, title: 'Conversion Optimization', color: 'bg-green-500', completed: stepProgress.step8 },
    { id: 9, title: 'Authority Amplification', color: 'bg-purple-500', completed: stepProgress.step9 }
  ];
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="text-3xl font-bold text-orange-500">
                {Object.values(stepProgress).filter(Boolean).length}
              </div>
              <div className="text-sm text-gray-600">Steps Completed</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-blue-500">
                {Math.round((Object.values(stepProgress).filter(Boolean).length / 9) * 100)}%
              </div>
              <div className="text-sm text-gray-600">Overall Progress</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-green-500">
                {9 - Object.values(stepProgress).filter(Boolean).length}
              </div>
